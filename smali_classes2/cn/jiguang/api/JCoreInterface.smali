...
.method public static getConnectionState(Landroid/content/Context;)Z
    ...
    :cond_0
    invoke-static {p0}, Lcn/jiguang/d/a/d;->j(Landroid/content/Context;)Lcn/jiguang/d/b/a;
...
.method public static getRuningFlag()Z
    ...
    invoke-static {}, Lcn/jiguang/d/b/b;->a()Z
...
.method public static restart(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Z)V
    ...
    const-string p1, "cn.jpush.android.intent.RESTOREPUSH"

    goto :goto_0

    :cond_2
    const-string p1, "cn.jpush.android.intent.INIT"
    ...
    invoke-virtual {p3, p0, p1, p2}, Lcn/jiguang/d/d/m;->b(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
...
.method public static sendAction(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1, p0, v0, p2}, Lcn/jiguang/d/d/m;->b(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static sendData(Landroid/content/Context;Ljava/lang/String;I[B)V
    ...
    invoke-virtual {p1, p0, p2, v0}, Lcn/jiguang/d/d/m;->b(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static setPowerSaveMode(Landroid/content/Context;Z)V
    ...
    const-string v1, "cn.jpush.android.intent.power.save"

    invoke-virtual {p1, p0, v1, v0}, Lcn/jiguang/d/d/m;->b(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
