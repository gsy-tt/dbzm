...
.method public static createSSLConnection()V
    ...
    invoke-virtual {v0, v1, v1, v2}, Ljavax/net/ssl/SSLContext;->init([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V
    ...
    new-instance v2, Lcn/jiguang/g/i;

    invoke-direct {v2}, Lcn/jiguang/g/i;-><init>()V

    sput-object v2, Lcn/jiguang/net/HttpUtils;->c:Ljavax/net/ssl/TrustManager;
...
.method public static httpGet(Landroid/content/Context;Lcn/jiguang/net/HttpRequest;)Lcn/jiguang/net/HttpResponse;
    ...
    invoke-virtual {v1, v3}, Lcn/jiguang/net/HttpResponse;->setResponseBody(Ljava/lang/String;)V

    :cond_3
    invoke-static {v2, v1}, Lcn/jiguang/net/HttpUtils;->a(Ljava/net/HttpURLConnection;Lcn/jiguang/net/HttpResponse;)V
    :try_end_1
    ...
    const-string v3, "http post Exception error:"
    ...
    const-string v2, "UNKnow execption"
    ...
    const-string v1, "default ssl failed,will use http get once"
    ...
    const-string v3, "http post IOException error:"
...
.method public static httpPost(Landroid/content/Context;Lcn/jiguang/net/HttpRequest;)Lcn/jiguang/net/HttpResponse;
    ...
    const-string v2, "http post IOException error:"
